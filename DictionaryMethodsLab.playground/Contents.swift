 ...
 */
// write your code here
var starWarsCharacters = ["Heros" : starWarsHeroes, "Villians" : starWarsVillians, "Droids" : starWarsDroids]
...
/*
// Alternative Method.
let starWarCharactersKeys = Array(starWarsCharacters.keys)
for keys in starWarCharactersKeys {
    print("\(keys)")
}
 */
 ...
 */
// write your code here
// The Else-statement prints to the screen. This should print because the dictionary is not empty.
...
let updatedDictionary1 = starWarsCharacters.updateValue(starWarsJedi, forKey: "Jedi")

if updatedDictionary1 == nil {
...
let updatedDictionary2 = starWarsCharacters.removeValueForKey("Bounty Hunters")

if updatedDictionary2 == nil {
